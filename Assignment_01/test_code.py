...
# =====================================================================
# ค่าคงที่ทิศทาง - ต้องนิยามก่อน CONFIG เพราะคอนฟิกอ้างชื่อทิศเหล่านี้
# =====================================================================
...
def tof_forward_offset_mm():
    ...
    """
    if TOF_FORWARD_OFFSET_MM is not None:
        return float(TOF_FORWARD_OFFSET_MM)
    return CELL_SIZE_M * 1000.0 / 2.0 - FRONT_STOP_MM
...
def place_on_target(driver, payload, heading, room_behind_m,
    ...
    total = len(AIM_SEQUENCE)
    print("[AIM] เล็งเป้าก่อนวาง {0} ขั้น".format(total))
    for index, step in enumerate(AIM_SEQUENCE, 1):
